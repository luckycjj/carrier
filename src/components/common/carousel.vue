    ...
    <div id="carousel" v-if="show">
           <ul>
              <li v-for="(item,index) in imgList" v-show="nowIndex == index" :class="nowIndex == index ? 'in' : ''">
                ...
                <button v-if="index == imgList.length - 1 " @click="showFalse()">开启抢单</button>
              </li>
           </ul>
           <div id="circleBox">
...
<script>
  ...
  export default {
        ...
        data(){
           return{
             imgList:[require("../../images/img1.png"),require("../../images/img2.png"),require("../../images/img3.png"),require("../../images/img4.png")],
             nowIndex:0,
             startX:0,
             endX:0,
             startY:0,
