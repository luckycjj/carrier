    ...
    <div  v-if="boxShow" id="mescroll" class="mescroll" @touchstart="liTouchstart($event)" @touchmove="liTouchmove($event)" :style="{top:Ultop+'rem'}">
      <ul id="dataList" class="data-list">
        <li v-for="item in pdlist">
          ...
          <div class="message">
            <div class="proStatus">
              <p  :class="'trackMoreIcon' + type">{{item.orderValue}}</p>
              ...
              <div id="sure"  v-if="type==1 || type == 0">
                ...
                <div class="go"  v-else>
                  <button v-if="type==1 || type == 0" @touchend="genghuan()">更换车辆</button>
                  <div class="clearBoth"></div>
                </div>
              </div>
            </div>
...
<style scoped>
  ...
  .trackMoreIcon0{
    background-image: url("../../images/trackMoreIcon0.png");
  }
  .trackMoreIcon1{
    background-image: url("../../images/trackMoreIcon1.png");
  }
  .trackMoreIcon2{
    background-image: url("../../images/trackMoreIcon2.png");
  }
  .trackMoreIcon3{
    background-image: url("../../images/trackMoreIcon3.png");
  }
  .trackMoreIcon4{
    background-image: url("../../images/trackMoreIcon4.png");
  }
  .trackMoreIcon5{
    background-image: url("../../images/trackMoreIcon5.png");
  }
  .trackMoreIcon6{
    background-image: url("../../images/trackMoreIcon6.png");
  }
  .trackMoreIcon7{
    background-image: url("../../images/trackMoreIcon7.png");
  }
  .trackMoreIcon8{
    background-image: url("../../images/trackMoreIcon8.png");
  }
  .trackMoreIcon9{
    background-image: url("../../images/trackMoreIcon9.png");
  }
  .trackMoreIcon10{
    background-image: url("../../images/trackMoreIcon10.png");
  }
</style>
